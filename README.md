...
A "work in progress" UNTETHERED iOS jailbreak for 64-bit devices created by [qwertyoruiopz](https://twitter.com/qwertyoruiopz) and [marcograssi](marcograss), and hopefully being made untethered by bob-2017.
...
In the near (probably distant) future, the jailbreak will support the following devices:

| Device | Version |
|---------|----------|
| iPhone 7  | iOS 10.0.0 -> iOS 10.2.1 |
| iPad Pro  | iOS 10.0.0 -> iOS 10.2.1 |
| iPhone 6S  | iOS 10.0.0 -> iOS 10.2.1 |
| iPhone SE  | iOS 10.0.0 -> iOS 10.2.1 |
| iPhone 5S  | iOS 10.0.0 -> iOS 10.2.1 |
| iPad Air| iOS 10.0.0 -> iOS 10.2.1 |
| iPad Mini 2| iOS 10.0.0 -> iOS 10.2.1 |
| iPhone 6  | iOS 10.0.0 -> iOS 10.2.1 |
| iPad Mini 3| iOS 10.0.0 -> iOS 10.2.1 |
| iPad Air 2| iOS 10.0.0 -> iOS 10.2.1 |
| iPad Mini 4 | iOS 10.0.0 -> iOS 10.2.1 |
| iPod touch (6G)  | iOS 10.0.0 -> iOS 10.2.1 |
